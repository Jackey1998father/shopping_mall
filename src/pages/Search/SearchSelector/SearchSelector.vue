  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(trademark) in trademarkList " :key="trademark.tmId" @click="funtmName(trademark)">{{trademark.tmName}}</li>
    ...
    <div class="type-wrap" v-for="(attrs) in attrsList " :key="attrs.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(a,index) in attrs.attrValueList " :key="index"   @click="funprops(attrs.attrId,a,attrs.attrName)">
            <a>{{a}}</a>
          </li>
...
import { mapGetters } from "vuex";
  export default {
    ...
    methods:{
      funtmName(value){
        this.x.$emit("getBrand",value)

      },
      funprops(Id,attributeValue,attributeName){
        this.x.$emit("attrsList",Id,attributeValue,attributeName)
